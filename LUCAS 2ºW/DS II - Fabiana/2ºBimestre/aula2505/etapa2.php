    ...
    <table border="1" align="center" width="50%">
        ...
        <tr>
            <td>
                ...
                <input type="hidden" name="CA" value="<?php print $_POST["CA"];?>">
                <input type="hidden" name="EU" value="<?php print $_POST["EU"];?>">
                <input type="hidden" name="IG" value="<?php print $_POST["IG"];?>">
                <input type="hidden" name="AU" value="<?php print $_POST["AU"];?>">
